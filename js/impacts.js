...
var impacts=[{
    ...
    title: "OCEANS",
    icon: "<img class='title-icon' src='./img/ocean.svg'>",
    info: "Marine heatwaves: relative to pre-industrial levels.<br><br>OOcean acidity: percentage relates to change in concentration of hydrogen ions; relative to 1986-2005; median and 5th-95th percentile range.<br><br>AMOC: relative to pre-industrial levels.",
