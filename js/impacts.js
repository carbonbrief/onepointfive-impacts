    ...
    var impacts=[{
        ...
        info: " Arctic sea ice: 'ice-free' is defined as an average September sea ice extent of less than one million km2.<br><br>Permafrost: Relative to 1961-90; uncertainty is a one standard deviation range",
        ...
        title: "ICE",
        icon: "<i class='fas fa-snowflake'></i>",
        info: "Snow extent: relative to 1971-2000. <br><br>Snow storage: percent of global land area (exc. Antarctica and Greenland) seeing changes in maximum monthly snow storage in calendar month with maximum storage in historical decade.",
        background: "https://www.carbonbrief.org/wp-content/uploads/2015/07/Stock-wall-street-new-york-finance.jpg",
        credit: "",
        map: "Global",
        location: "Global"
        ...
        title: "STORMS AND FLOODING",
        icon: "<img class='title-icon' src='../img/cyclone.svg'>",
        info: "Population held constant at 2015 levels; relative to 1976-2005.<br><br>Frequency of extreme high flows: return period for a 1-in-100 year extreme high flows in 2006-15.",
        background: "https://www.carbonbrief.org/wp-content/uploads/2015/07/Stock-wall-street-new-york-finance.jpg",
        credit: "",
        map: "europe",
        location: "Europe"
